...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycby9QCly-0XBtGHUqanlO6mPWRn79e_XOYhYUG6irCL60WG96JJpDCc4iTOdLRuVeUOa/exec";
    ...
    try {
      ...
      const response = await fetch(SCRIPT_URL, {
        ...
        body: new URLSearchParams({
          ...
          fileName: file.name,
          mimeType: file.type,
          folderId: '1iGV43CdxC1Wo-ExYnipHa_iBoV9GlylH'
        })
      });
