...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const updateJoiningResponse = await fetch('https://script.google.com/macros/s/AKfycby9QCly-0XBtGHUqanlO6mPWRn79e_XOYhYUG6irCL60WG96JJpDCc4iTOdLRuVeUOa/exec', {
      method: 'POST',
    ...
    const updateReasonResponse = await fetch('https://script.google.com/macros/s/AKfycby9QCly-0XBtGHUqanlO6mPWRn79e_XOYhYUG6irCL60WG96JJpDCc4iTOdLRuVeUOa/exec', {
      method: 'POST',
    ...
    const insertResponse = await fetch('https://script.google.com/macros/s/AKfycby9QCly-0XBtGHUqanlO6mPWRn79e_XOYhYUG6irCL60WG96JJpDCc4iTOdLRuVeUOa/exec', {
      method: 'POST',
      body: insertParams,
    });
