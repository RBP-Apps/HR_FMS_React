...
const fetchLeaveData = async () => {
  try {
    ...
    const response = await fetch(
      'https://script.google.com/macros/s/AKfycby9QCly-0XBtGHUqanlO6mPWRn79e_XOYhYUG6irCL60WG96JJpDCc4iTOdLRuVeUOa/exec?sheet=Leave Management&action=fetch'
    );
...
const fetchGatePassData = async () => {
  try {
    const response = await fetch(
      'https://script.google.com/macros/s/AKfycby9QCly-0XBtGHUqanlO6mPWRn79e_XOYhYUG6irCL60WG96JJpDCc4iTOdLRuVeUOa/exec?sheet=Gate Pass&action=fetch'
    );
